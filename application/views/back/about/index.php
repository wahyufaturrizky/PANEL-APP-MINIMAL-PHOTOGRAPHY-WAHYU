			...
			<div id="input">
				<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="card-box">
								<h4 class="m-t-0 header-title">Input Foto About</h4>
								<hr>
								<div class="row">
									<div class="col-12">
										<div class="p-20">
											...
											<div class="form-group row">
												<label class="col-2 col-form-label">Photo Profile 01 *</label>
												<div class="col-10">
						...
						<div class="col-md-6">
							<div class="card-box">
								<h4 class="m-t-0 header-title">Input Header & Deskripsi About</h4>
								<hr>
								<div class="row">
									<div class="col-12">
										<div class="p-20">
											...
											<div class="form-group row">
												...
												<div class="col-10">
													<textarea id="i_description" class="form-control head" name="description" rows="8"
											...
											<div class="form-group row">
												<label class="col-2 col-form-label">Deskripsi *</label>
												<div class="col-10">
													<textarea id="i_foot_note" class="form-control head" name="foot_note" rows="8"
														placeholder="Please fill description here..."></textarea>
												</div>
											</div>
...
<?php $this->load->view('back/about/js_about') ?>