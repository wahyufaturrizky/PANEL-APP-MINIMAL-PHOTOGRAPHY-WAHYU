		...
		<div class="card-box">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="input">
					<div class="card-box">
						<h4 class="m-t-0 header-title">Input Journal Avianbrands</h4>
						<hr>
						<div class="row">
							<div class="col-12">
								<div class="p-20">
									<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<Input type="date" id="i_create_date" class="form-control" name="create_date" rows="8" placeholder="Please fill create date here...">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<Input type="date" id="i_udpate_date" class="form-control" name="udpate_date" rows="8" placeholder="Please fill udpate date here...">
											</div>
										</div>

										<div class="form-group row">
											<label class="col-2 col-form-label">Add to Home or not?</label>
											<div class="col-10">
												<input value="1" type="checkbox" id="i_status" name="status" data-plugin="switchery" data-color="#64b0f2" data-size="small"/>
											</div>
										</div>
										...
										<div class="col-4 offset-8">
											<div class="pull-right">
												<button type="submit" id="btn-submit" class="btn btn-success waves-light waves-effect">
												...
												<button id="btn-addfrom" type="button" class="btn btn-info waves-light waves-effect">
													<i class="fa fa-add"></i> Add Form
												</button>

												<button id="btn-cancel" type="button" class="btn btn-danger waves-light waves-effect">
...
<?php $this->load->view('back/journal/js_journal') ?>