...
<html lang="en">
    ...
    <head>
        ...
        <!-- Plugin Css -->
        <link rel="stylesheet" href="<?= base_url() ?>assets/backend/plugins/switchery/switchery.min.css" />
    ...
    <body>
        ...
        <!-- Plugin Js -->
        <script src="<?= base_url() ?>assets/backend/plugins/switchery/switchery.min.js"></script>
