			...
			<div id="input">
				<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card-box">
								<h4 class="m-t-0 header-title">Input Header & Deskripsi Home</h4>
								<hr>
								<div class="row">
									<div class="col-12">
										<div class="p-20">
											...
											<div class="form-group row">
												...
												<div class="col-10">
													<input id="i_create_date" class="form-control head" name="create_date" rows="8"
											...
											<div class="form-group row">
												...
												<div class="col-10">
													<input id="i_udpate_date" class="form-control head" name="udpate_date" rows="8"
														placeholder="Please fill description here...">
												</div>
											</div>
...
<?php $this->load->view('back/home/js_home') ?>