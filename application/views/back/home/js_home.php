<script type="text/javascript">
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Home/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
            success:function(data){ 
                ...
                $("#i_create_date").val(data.create_date);
                $("#i_udpate_date").val(data.udpate_date);
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Home/save_home/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.value) {
            $.ajax({
                url: '<?= base_url() ?>Home/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
